...
smalltalk.addClass('TTClientTest', smalltalk.TestCase, ['client'], 'Tide-Amber-Tests');
smalltalk.addMethod(
smalltalk.method({
selector: "setUp",
...
smalltalk.addClass('TTMockProxy', smalltalk.TTProxy, ['catchedSelectors'], 'Tide-Amber-Tests');
smalltalk.addMethod(
smalltalk.method({
...
smalltalk.addClass('TTProxyTest', smalltalk.TestCase, [], 'Tide-Amber-Tests');
smalltalk.addMethod(
smalltalk.method({
selector: "testDNU",
category: 'tests',
